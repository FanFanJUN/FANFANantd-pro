...
import { connect, FormattedMessage, useIntl } from 'umi'; import styles from './BaseView.less';
          ...
          <Form layout="vertical" onSubmit={this.handleSubmit} hideRequiredMark>
            ...
            <FormItem label={intl.formatMessage({ id: 'app.settings.basic.profile' })}>
              {getFieldDecorator('profile', {
                ...
                <Input.TextArea
                  placeholder={intl.formatMessage({ id: 'app.settings.basic.profile-placeholder' })}
                  rows={4}
                />
              )}
            </FormItem>
            ...
            <FormItem label={intl.formatMessage({ id: 'app.settings.basic.geographic' })}>
              {getFieldDecorator('geographic', {
                rules: [
                  {
                    required: true,
                    message: intl.formatMessage({ id: 'app.settings.basic.geographic-message' }, {}),
                  },
                  {
