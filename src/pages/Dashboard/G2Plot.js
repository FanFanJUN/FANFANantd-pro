...
class G2Plot extends React.PureComponent {
  componentDidMount() {
    this.initMap();
  }
  ...
  initMap=() => {
    ...
    chartsWraper.style.height = `${getSessionStorage('contentMinHeight')}px`;
    container.appendChild(chartsWraper);

    const canvasDiv1 = document.createElement('div');
    canvasDiv1.style.width = '50%';
